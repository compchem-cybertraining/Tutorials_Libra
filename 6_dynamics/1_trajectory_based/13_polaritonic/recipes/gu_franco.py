...
def load(dyn_general):
    ...
    dyn_general.update({ "decoherence_algo":9}) # new Gu-Franco approach
    ...
    dyn_general.update( { "decoherence_times_type":5, "reorg_energy":0.00, "Temperature":300.0 } ) # Gu-Franco decoherence - need to define the actual 
                                                                                                   # reorganization energy and temperature
