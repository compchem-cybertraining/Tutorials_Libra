...
params['mpi_executable'] = "srun --mpi=pmi2 "
...
# Lowest and highest orbital (1-based), Here HOMO is 24 
params['lowest_orbital'] = 1
params['highest_orbital'] = 40 
...
params['trajectory_xyz_filename'] = path + '/../Rutile_TiO2_MD-pos-1.xyz'
